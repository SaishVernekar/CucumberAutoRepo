...
public class PostJSONwithschema {
	...
	public void user_update_name_with_name (String username) throws IOException{
		...
		//Read data from file 
	    data = new String(Files.readAllBytes(Paths.get("/Users/avernek/git/TrimbleGIT/CumcumberTrimble/src/test/Resources/UpdatePOSTjsonwithschema/POST2.json"))); 
	...
	@When("^user update job with \"([^\"]*)\" name$")
